 ...
 */
$messages['en'] = array(
	'e3experiments-desc' => 'Provides a scaffold for members of the [https://www.mediawiki.org/wiki/Editor_Engagement_Experiments Editor Engagement Experiments] to use when deploying simple experiments',
);
